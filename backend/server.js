...
const connection_url = "mongodb+srv://shreyasbharadhwaj18:EmDiX6L6C8EBvvCH@cluster0.nl9mdya.mongodb.net/?retryWrites=true&w=majority";
...
app.post('/v2/posts/', (req, res) => {
    ...
    Video.create(dbVideos).then((result) => {
